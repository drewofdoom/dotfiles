...
const float TRAIL_SIZE = 0.2; // 0.0 = all corners move together. 1.0 = max smear (leading corners jump instantly)
...
const float TRAIL_THICKNESS = 0.5;  // 1.0 = full cursor height, 0.0 = zero height, >1.0 = funky aah
const float TRAIL_THICKNESS_X = 0.4;
